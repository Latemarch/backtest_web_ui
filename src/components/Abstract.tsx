	...
	return (
		<div className="flex flex-col w-1/2 text-justify items-center gap-2 p-2">
			...
			<span>
				...
				trend.
				<br /> This investment strategy operates on the assumption that the MACD
				value has periodicity. When an upward trend begins from a negative MACD
				value, this is taken as a signal to buy, and once the upward trend has
				progressed to some extent (as defined by the MACD count), profits are
				realized.
				<br /> For all position entries, profit cut points and loss cut points
				are set. The values of the two moving averages (MA1, MA2) for basic MACD
				settings are set at 12 and 26, respectively. The signal line (MACD
				length) of the MACD is set at 9.
			</span>
		</div>
	);
}
